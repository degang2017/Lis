srcdir = /root/soft/php-7.1.10/ext/lis
builddir = /root/soft/php-7.1.10/ext/lis
top_srcdir = /root/soft/php-7.1.10/ext/lis
top_builddir = /root/soft/php-7.1.10/ext/lis
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php7_1.10/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php7_1.10/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = gawk
shared_objects_lis = lis.lo lis_application.lo lis_exception.lo lis_config.lo lis_request.lo lis_loader.lo lis_router.lo lis_view.lo lis_model.lo lis_container.lo
PHP_PECL_EXTENSION = lis
PHP_MODULES = $(phplibdir)/lis.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/php7_1.10
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/php7_1.10
phplibdir = /root/soft/php-7.1.10/ext/lis/modules
phpincludedir = /usr/local/php7_1.10/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /usr/local/php7_1.10/lib/php/extensions/no-debug-zts-20160303
PHP_EXECUTABLE = /usr/local/php7_1.10/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php7_1.10/include/php -I/usr/local/php7_1.10/include/php/main -I/usr/local/php7_1.10/include/php/TSRM -I/usr/local/php7_1.10/include/php/Zend -I/usr/local/php7_1.10/include/php/ext -I/usr/local/php7_1.10/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
